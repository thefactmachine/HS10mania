fn_wrapper_create_all_graphs <- function(a_df_data, a_vct_HS10, a_vct_top_n_country, a_lst_args) {
  ...
  fn_message_log(a_lst_args$product_name, 
                 "monthly value graph - created (outputs/monthly_value)")
  ...
  fn_message_log(a_lst_args$product_name, 
                 "monthly volume graph - created (outputs/monthly_volume)")
  ...
  fn_message_log(a_lst_args$product_name, 
                 "monthly smoothed price graph - created (outputs/smoothed_price)")
  ...
  fn_create_graph_monthly(df_monthly_vvn, "outputs/graphs", 
                          ...
                          a_lst_args$str_title_year_end)
  fn_message_log(a_lst_args$product_name, 
                 "monthly number of countries graph - created (outputs/monthly_number_countries)")
  ...
  fn_message_log(a_lst_args$product_name, 
                 "yearly summary graph - created (outputs/yearly_summary)")
